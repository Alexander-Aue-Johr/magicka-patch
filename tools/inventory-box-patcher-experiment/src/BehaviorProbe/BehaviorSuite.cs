...
internal static class BehaviorSuite
{
    internal static BehaviorReport Run(Assembly magicka, bool runtimePatchEnabled)
    {
        ...
        ProjectileSpellMissileLifecycleScenarios.Run(
            ...
            runtimePatchEnabled,
            report);
        NetworkEntityUpdateLifecycleScenarios.Run(
            magicka,
            runtimePatchEnabled,
            report);
        NetworkDamageLifecycleScenarios.Run(
            magicka,
            runtimePatchEnabled,
            report);
        NetworkSpawnHandleScenarios.Run(
            magicka,
            runtimePatchEnabled,
            report);
        NetworkPostInitializeScenarios.Run(
            magicka,
            runtimePatchEnabled,
            report);
        ...
        CharacterAvatarTemplateScenarios.Run(
            magicka, runtimePatchEnabled, report);
        InGameUiScaleSelectionScenarios.Run(
            magicka, runtimePatchEnabled, report);
        CharacterSelectAvatarTextureScenarios.Run(
            magicka, runtimePatchEnabled, report);
        CharacterSelectOfflineLeaveScenarios.Run(
            magicka, runtimePatchEnabled, report);
        MissileConditionInitializationScenarios.Run(
            magicka, runtimePatchEnabled, report);
        MissileEventTargetSentinelScenarios.Run(
            magicka, runtimePatchEnabled, report);
        MissileEntityLifetimeScenarios.Run(
            magicka, runtimePatchEnabled, report);
        ...
        ElementSelectionTelemetryScenarios.Run(
            ...
            runtimePatchEnabled,
            report);
        ModernControllerSchemeScenarios.Run(
            magicka,
            runtimePatchEnabled,
            report);
        HybridInputScenarios.Run(
            ...
            runtimePatchEnabled,
            report);
        ControllerOptionsMenuScenarios.Run(
            magicka,
            runtimePatchEnabled,
            report);
