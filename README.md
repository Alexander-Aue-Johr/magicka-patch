...
>
> - [Installer](https://github.com/Alexander-Aue-Johr/magicka-patch/releases/download/0.0.36/magicka-community-patch-0.0.36-installer.zip)
> - [Files only / manual installation](https://github.com/Alexander-Aue-Johr/magicka-patch/releases/download/0.0.36/magicka-community-patch-0.0.36-files-only.zip)
>
